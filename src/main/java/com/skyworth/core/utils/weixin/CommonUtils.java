...
public class CommonUtils {
	...
	// 公众号appId
	public final static String APP_ID = "wx5b7e7ad488a29445";
	// 公众号appSecret
	public final static String APP_SECREDT = "20aa2eab252cae34bb7723a75a85dc30";
	// 普通凭证获取（GET）
	...
	public static Token getToken() {
		Token token = null;
		String requestUrl = GET_TOKEN_URL.replace("APPID", APP_ID).replace("APPSECRET", APP_SECREDT);
		// 发起GET请求获取凭证
